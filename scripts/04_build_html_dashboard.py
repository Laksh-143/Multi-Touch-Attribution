...
"""
    ...
    print(f"\n[SUCCESS] Standalone Interactive Dashboard created at: {os.path.abspath(output_path)} and index.html")
    print("You can double-click 'dashboard.html' or 'index.html' in Windows Explorer to open it in Chrome or Edge!")
